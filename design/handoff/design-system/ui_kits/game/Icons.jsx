/* FutCopa icons — Lucide (MIT) glyph paths, 2px stroke round style.
   Rendered as a single <Icon name size> React component. */
const FC_ICON_PATHS = {
...
function Icon({ name, size = 22, stroke = 2, className = "", style = {} }) {
  const inner = FC_ICON_PATHS[name];
...
Object.assign(window, { Icon, FC_ICON_PATHS });
